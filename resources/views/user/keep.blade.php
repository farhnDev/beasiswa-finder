...
@section('content')
    ...
    <section class="pt-3">
        <div class="container-fluid" style="background-image: url('/assets/animasi.svg'); width: 100%; height: 250px;">
            <p class="text-light text-center" style="padding-top: 80px; font-size: 50px; font-family: Poetsen One, sans-serif;">Keep</p>
        </div>
    </section>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('saveBookmark', ['beasiswa' => $beasiswa->id]) }}"
                                ...
                                <!-- SVG Bookmark Icon -->
                                <svg xmlns="http://www.w3.org/2000/svg"  class="bookmark-icon saved" id="bookmark-icon-{{ $beasiswa->id }}" height="30px" viewBox="0 -960 960 960"
