...
/* .rating {
        ...
        <section>
            ...
            {{-- ini rating yang awal render sedikit error dengan alasan akan lopping terus menerus --}}
            {{-- <article class="container">
                <header>
                    ...
                    <form id="ratingForm" action="{{ route('beasiswa.rate', $beasiswa) }}" method="POST">
                        ...
                        @for ($i = 5; $i >= 1; $i++)
                            <input type="radio" id="star-{{ $i }}" name="rating" value="{{ $i }}"
                                   {{ $beasiswa->ratings->where('user_id', auth()->id())->first()?->rating == $i ? 'checked' : '' }}>
                            <label for="star-{{ $i }}">
            ...
            <article class="container">
                ...
                <form action="{{ route('beasiswa.comment', $beasiswa) }}" method="POST">
                    ...
                    <div class="form-group" style="width: 300px;">
                        ...
                        <button type="submit" class="btn btn-dark mt-3 w-100">Submit Comment</button>
                    </div>
                </form>
            </article>
    ...
    <section>
        ...
        <div class="mt-4">
            ...
            <form action="{{ route('beasiswa.comment', $beasiswa) }}" method="POST">
                ...
                <button type="submit" class="btn btn-dark mt-3 w-50">Submit Comment</button>
            </form>
        </div>
